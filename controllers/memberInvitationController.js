...
const handleMemberRegistrationInvitationResponse = asyncError(
  async (req, res) => {
    try {
      ...
      const updatedUser = await User.findByIdAndUpdate(
        id,
        { username,password:hashedPassword,isUserRegistered:true },
        { new: true }
      );
...
export {
  ...
  handleMemberRegistrationInvitationResponse,
};
